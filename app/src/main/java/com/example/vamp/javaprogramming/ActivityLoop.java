...
import com.example.vamp.javaprogramming.Adaptor.PagerAdapterc;
...
public class ActivityLoop extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        PagerAdapterc pagerAdapter= new com.example.vamp.javaprogramming.Adaptor.PagerAdapterc(getSupportFragmentManager());
