...
import com.example.vamp.javaprogramming.Adaptor.PagerAdaptera;
...
public class ActivityIntro extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        PagerAdaptera pagerAdapter= new com.example.vamp.javaprogramming.Adaptor.PagerAdaptera(getSupportFragmentManager());
